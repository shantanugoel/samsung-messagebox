...
def buildMessage(args):
  body = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" + "<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\" s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">" + "<s:Body>" + "      <u:AddMessage xmlns:u=\"urn:samsung.com:service:MessageBoxService:1\">" + "         <MessageType>text/xml</MessageType>" + "         <MessageID>MessageId</MessageID>" + "<Message>" + "&lt;Category&gt;SMS&lt;/Category&gt;" + "&lt;DisplayType&gt;Maximum&lt;/DisplayType&gt;" + "&lt;ReceiveTime&gt;" + "&lt;Date&gt;2010-05-04&lt;/Date&gt;" + "&lt;Time&gt;01:02:03&lt;/Time&gt;" + "&lt;/ReceiveTime&gt;" + "&lt;Receiver&gt;" + "&lt;Number&gt;" + args.receiver_no + "&lt;/Number&gt;" + "&lt;Name&gt;" + args.receiver + "&lt;/Name&gt;" + "&lt;/Receiver&gt;" + "&lt;Sender&gt;" + "&lt;Number&gt;" + args.sender_no + "&lt;/Number&gt;" + "&lt;Name&gt;" + args.sender + "&lt;/Name&gt;" + "&lt;/Sender&gt;" + "&lt;Body&gt;" + args.msg + "&lt;/Body&gt;" + "</Message>" + "      </u:AddMessage>" + "   </s:Body>" + "</s:Envelope>";
...
def main():
  parser = argparse.ArgumentParser(description='Send Messages to Samsung TVs', add_help = False)
  ...
  flags.add_argument('-t', '--time', dest = 'time', default = None, help = 'Optional. Receive date and time in unix format')
